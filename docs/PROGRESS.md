...
| V3: Dense Data + Mesh Preview | In progress | OBJ, textured OBJ, and GLB/GLTF mesh preview are available with shaded/wire/both render modes and adjustable opacity. Dense point downsampling, automated GLB conversion, and richer texture inspection remain. |
